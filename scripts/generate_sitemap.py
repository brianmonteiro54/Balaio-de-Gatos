...
incluindo title/caption específicos por aula.
"""
...
# (file_path, url_path, priority, image_title, image_caption)
PAGES: list[tuple[str, str, str, str, str]] = [
    ...
    ("aula10/index.html", f"{BASE}/aula10/", "0.9",
     ...
     "Aula 10: caixa de ferramentas do AI Practitioner com OpenSearch, RAG, chunking, Knowledge Bases e modelos de difusão."),
...
def build_sitemap() -> str:
    ...
    for file_path, url, priority, img_title, img_caption in PAGES:
